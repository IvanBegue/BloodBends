        ...
        <header class="header">
            <div class="container">
                <nav class="navbar navbar-expand-xl">
                    <a class="navbar-brand" href="index.html">spooky</a>
                    <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="nav-icon fas fa-bars"></span>
                    </button>
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a class="nav-link scroll-to" data-scroll="specific-element-id" aria-current="page" href="#home">Home</a>
                            <a class="nav-link scroll-to" data-scroll="specific-element-id" href="#about">ABOUT</a>
                            <a class="nav-link scroll-to" data-scroll="specific-element-id" href="#artist">Power</a>
                            <?php

                            if(isset($_SESSION["id"])){
                                echo ' <a class="nav-link scroll-to" data-scroll="specific-element-id" href="logout.php">Logout</a>';
                            }else{
                                echo '<a class="nav-link scroll-to" data-scroll="specific-element-id" href="login.php">Login</a>';
                            }
        ...
        <section class="home-banner" id="home">
            <div class="container">
                <div class="banner-content pt-120 pb-120">
                    ...
                    <h5 class="font-alt ban-txt wow fadeInDown animated animated" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Smoothie Party</h5>
                    <p class="text-center wow fadeInUp animated animated" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;"> There are many Christians today that look at Halloween as a pagan holiday during which the devil is worshipped and evil is glorified.</p>
                    <div class="btn-bar text-center">
                        <a href="#" class=" wow fadeInDown animated animated" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInDown;">Know More</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section aboutus pt-120 pb-120" id="about">
            <div class="container">
                <div class="tittle-content mb-70 wow fadeInDown animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInDown;">
                    <h2>about Halloween Party</h2>
                    <p>
                        Halloween is thought to have roots in Christian beliefs and practices.The English word 'Halloween' comes from "All Hallows' Eve".
                    </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="footer_text wow slideInDown" data-wow-delay="1s" style="visibility: hidden; animation-delay: 1s; animation-name: none;">
                                <p>
                                    Copyright © 2024. All rights reserved by <a href="#0">NextGenerationDev</a>
                                </p>
                            </div>
